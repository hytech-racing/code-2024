...
MCP3204 adc_rr(ADC_VREF, RR_CS);
MCP3204 adc_rl(ADC_VREF, RL_CS);
void setup() {
  // configure PIN mode
  pinMode(RR_CS, OUTPUT);
  pinMode(RL_CS, OUTPUT);
  pinMode(10, OUTPUT);
  
  
  // set initial PIN state
  digitalWrite(RL_CS, HIGH);
  digitalWrite(RR_CS, HIGH);
...
uint16_t RR_LC_1 = adc_rr.read(MCP3204::Channel::SINGLE_1);
uint16_t RL_LC_1 = adc_rl.read(MCP3204::Channel::SINGLE_1);
uint16_t RR_LC_2 = adc_rr.read(MCP3204::Channel::SINGLE_0);
uint16_t RL_LC_2 = adc_rl.read(MCP3204::Channel::SINGLE_0);
// uint16_t FL_LC = 0;
  //uint16_t raw = analogRead(40);
   t2 = micros();

uint16_t rr_1 = adc_rr.toAnalog(RR_LC_1);
uint16_t rl_1 = adc_rl.toAnalog(RL_LC_1);
uint16_t rr_2 = adc_rr.toAnalog(RR_LC_2);
uint16_t rl_2 = adc_rl.toAnalog(RL_LC_2);
// uint16_t b1 = adc.toAnalog(brake1);
// uint16_t b2= adc.toAnalog(brake2);
   Serial.print("rr value: ");
   Serial.print(RR_LC_1);
   Serial.print(" (");
   Serial.print(rr_1);
   Serial.print(" mV)    ");
   Serial.print(RR_LC_2);
   Serial.print(" (");
   Serial.print(rr_2);
   Serial.println(" mV)");

   Serial.print("rl value: ");
   Serial.print(RL_LC_1);
   Serial.print(" (");
   Serial.print(rl_1);
   Serial.print(" mV)    ");
   Serial.print(RL_LC_2);
   Serial.print(" (");
   Serial.print(rl_2);
   Serial.println(" mV)");
