...
#define LOAD_CELL1_OFFSET 63.7-33.98+6.8
#define LOAD_CELL1_SLOPE 0.1711
#define LOAD_CELL2_OFFSET (9.4-35.59+9.4)
#define LOAD_CELL2_SLOPE 0.1762
#define LOAD_CELL3_OFFSET (0.9-33.59+14.1)
#define LOAD_CELL3_SLOPE 0.192
#define LOAD_CELL4_OFFSET (2.7-64.5+16.7)
