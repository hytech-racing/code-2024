...
//        #define MAX_ACCELERATOR_PEDAL_2 1250   // High accelerator implausibility threshold
        ...
        #define START_BRAKE_PEDAL_1 2140  // Position to start brake // 2078 + pressure
        #define END_BRAKE_PEDAL_1 2500    // Position to max out brake 2718 +-5
...
//brake 2 is negative slope
        ...
        #define START_BRAKE_PEDAL_2 1965  // Position to start brake //2045 - pressure 
        #define END_BRAKE_PEDAL_2 1500    // Position to max out brake //1410 +- 5
        ...
        #define BRAKE_THRESHOLD_MECH_BRAKE_1 2400 // brake 1, mech brake threshold +-5
        #define BRAKE_THRESHOLD_MECH_BRAKE_2 1710 // brake 2, mech brake threshold +-5
    #else
