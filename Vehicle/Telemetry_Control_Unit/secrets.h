...
const char currentDynamicKey[] =        "CURRENT KEY HERE";
const uint16_t currentKeyGPSWeek =      2258; // Update this when you add new keys
const uint32_t currentKeyGPSToW =       0;

const uint8_t nextKeyLengthBytes =      16; 
const char nextDynamicKey[] =           "NEXT KEY HERE";
const uint16_t nextKeyGPSWeek =         2262; // Update this when you add new keys
