...
private:
    int16_t lat_accel; // @Parse @Name(lat_accel) @Unit(m/s^2) @Scale(1000)
    int16_t long_accel; // @Parse @Name(long_accel) @Unit(m/s^2) @Scale(1000)
    int16_t vert_accel; // @Parse @Name(vert_accel)@Unit(m/s^2) @Scale(1000)
