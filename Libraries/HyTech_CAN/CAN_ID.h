#define ID_MC1_STATUS												0xB0
#define ID_MC2_STATUS												0xB1
#define ID_MC3_STATUS												0xB2
#define ID_MC4_STATUS												0xB3
#define ID_MC1_TEMPS												0xB4
#define ID_MC2_TEMPS												0xB5
#define ID_MC3_TEMPS												0xB6
#define ID_MC4_TEMPS												0xB7
#define ID_MC1_ENERGY												0xB8
#define ID_MC2_ENERGY												0xB9
#define ID_MC3_ENERGY												0xBA
#define ID_MC4_ENERGY												0xBB

#define ID_MC1_SETPOINTS_COMMAND									0xA0
#define ID_MC2_SETPOINTS_COMMAND									0xA1
#define ID_MC3_SETPOINTS_COMMAND									0xA2
#define ID_MC4_SETPOINTS_COMMAND									0xA3
