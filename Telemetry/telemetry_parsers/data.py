...
class BMS_detailed_voltages(data):
    def parse(data, id = None, time = None):
        msg_id = 0xD8
        if id is not None:
            mask = id==msg_id
...
class BMS_onboard_detailed_temperatures(data):
    def parse(data, id = None, time = None):
        msg_id = 0xD6
        if id is not None:
            mask = id==msg_id
...
class BMS_onboard_temperatures(data):
    def parse(data, id = None, time = None):
        msg_id = 0xD5
        if id is not None:
            mask = id==msg_id
...
class MCU_analog_readings(data):
    def parse(data, id = None, time = None):
        msg_id = 0xCC
        if id is not None:
            mask = id==msg_id
...
class MC2_setpoints_command(data):
    def parse(data, id = None, time = None):
        msg_id = 0xB1
        if id is not None:
            mask = id==msg_id
...
class MC3_setpoints_command(data):
    def parse(data, id = None, time = None):
        msg_id = 0xB2
        if id is not None:
            mask = id==msg_id
...
class MC4_setpoints_command(data):
    def parse(data, id = None, time = None):
        msg_id = 0xB3
        if id is not None:
            mask = id==msg_id
